                ...
                <div class="signup-form">
                    ...
                    <form action="includes/signup-helper.php" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <input type="text" id="inputEmail" class="form-control" name="fname" placeholder="First Name"
                                        required autofocus>
                                </div>
                                <div class="col">
                                    <input type="text" id="inputEmail" class="form-control" name="lname" placeholder="Last Name"
                                        required autofocus>
                                </div>
                            </div>
                        </div>
                        <input type="text" id="inputEmail" class="form-control" name="uname" placeholder="Username"
                                        required autofocus>
